                                ...
                                <div class="footer-content">
                                    <div class="footer-content-inner">
                                        <div class="footer-logo">
                                            <img src="{{ asset($IdentitySchool && $IdentitySchool->logo ? 'storage/' . $IdentitySchool->logo : 'backend/assets/images/NoImage.png') }}" with="200px" hight="200px" alt="School Logo">
                                        </div>
                                        <p>{{ $IdentitySchool->name_school ?? '-'}}</p>
                                        <div>
                                            <iframe
                                    ...
                                    <div class="footer-content-inner">
                                        ...
                                        <div class="footer-content-inner footer-content-inner-last-child">
                                            ...
                                            <div class="footer-gallery d-flex">
                                                <a href="{{ asset($berita && $berita->image ? 'storage/' . $berita->image : 'backend/assets/images/NoImage.png')}}"
                                                    class="footer-gallery-link lightbox-image" data-fancybox="gallery">
                                                    <div class="footer-gallery-item">
                                                        <img src="{{ asset($berita && $berita->image ? 'storage/' . $berita->image : 'backend/assets/images/NoImage.png')}}" alt="image">
                ...
                <div class="col-xl-12">
                    <div class="footer-bottom-wrapper">
                        <div class="footer-copyright">
                            <p>Copyrights © 2024 Muhammadiah</p>
                        </div>
